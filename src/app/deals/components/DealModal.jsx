...
export default function DealModal({
    ...
    const validate = () => {
        ...
        const hasAssignedMultiple =
            Array.isArray(formData.assignedToUserIds) &&
            formData.assignedToUserIds.length > 0;
        if (!hasAssignedSingle && !hasAssignedMultiple)
            newErrors.assignedToUserId = t("Assigned User is required");
        if (!formData.value || formData.value <= 0)
            newErrors.value = t("Value must be greater than zero");
    ...
    const handleSave = () => {
        ...
        const multipleAssignedIds = Array.isArray(formData.assignedToUserIds)
            ...
            : [];
        const primaryAssignedId =
            multipleAssignedIds.length > 0
    ...
    return (
        <div className="fixed inset-0 z-50 flex bg-black/50 text-gray-800">
            <div
                className="
          relative
          ...
          rounded-none
          sm:rounded-lg
          sm:max-w-4xl sm:mx-auto sm:my-8 sm:max-h-[85vh]
          p-4 sm:p-6
        "
            >
                <button
                      ...
                      : t("Select users")}
                                ...
                                <svg
                                    className={`w-4 h-4 transition-transform ${
                                        isAssignedDropdownOpen ? "rotate-180" : ""
                                    }`}
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <input
                                                                ...
                                                                disabled={!isActive}
                                                                onChange={() =>
                                                                    toggleAssignedUser(normalizedId)
                                                                }
                                                            />
                            ...
                            {errors.assignedToUserId && (
                                <p className="text-red-500 text-xs mt-1">
                                    {errors.assignedToUserId.replace("Role", "User")}
                                </p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    handleInputChange("entityId", e.target.value)
                                }
                                className={`border p-2 w-full rounded ${
                                    errors.entityId ? "border-red-500" : ""
                                }`}
                            >
                                <option value="">
                                    {formData.entityType === "campaign"
                        ...
                        <div className="lg:col-span-3 flex items-center">
                            <input
                                ...
                                onChange={(e) =>
                                    handleInputChange("isFinished", e.target.checked)
                                }
                ...
                <div className="mt-4 sm:mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                    <button
                        type="button"
                        onClick={onClose}
                        className="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 cursor-pointer"
                    >
                        {t("Cancel")}
                    </button>
                    <button
                        type="button"
                        onClick={handleSave}
                        className="w-full sm:w-auto px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer"
                    >
